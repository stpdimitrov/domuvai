...
### S-G1-04 · `registry` · BOOK · 10 rule(s)
...
| `PM-BOOK-005` | MUST | Adding an animal writes to the animals section and recalculates fee headcount. |
...
### S-G1-05 · `registry` · BOOK · ORG · 13 rule(s)
